...
export type MutationErrorCode =
  ...
  | "WORK_COPY_OPEN_PENDING"
  | "WORK_COPY_OPEN_STILL_PENDING"
  | "WORK_COPY_PENDING_ATTEMPT_NOT_FOUND"
  | "WORK_COPY_PENDING_ALREADY_AUTHORIZED"
  | "WORK_COPY_PENDING_INVALIDATED"
